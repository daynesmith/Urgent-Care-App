...
const { getPatientAppointments,getAllAppointments, getBillingStatus, billingStatus, createAppointmentReceptionist, updateAppointmentReceptionist, updateStatus, createAppointment, updateAppointment, getSingleAppointment, cancelAppointment, rescheduleAppointment } = require('../controllers/AppointmentsController')
