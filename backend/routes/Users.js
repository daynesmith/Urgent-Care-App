...
const { registerUser, loginUser, getSpeciality, updateEmployeeUsers, gettingApplications, getEmployeeUsers, creatingUser, updateApplicationStatus, clinicLocations, sendingApplications, getStaffUsers, getStaffShifts} = require('../controllers/usersController')
