...
export default function PatientDashboard(){
    ...
    <div className="flex justify-center flex-row flex-nowrap gap-2 text-sm font-mono">
        ...
        <Link as={Link} className="border rounded-l shadow-lg p-3 h-full text-center min-w-3xs"><h4>Medical History</h4> </Link> 
        <Link as={Link} className="border rounded-l shadow-lg p-3 h-full text-center min-w-3xs"><h4>Patient Profile</h4> </Link> 
